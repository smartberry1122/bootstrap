...
<Example class="bd-example-buttons" code={[...getData('theme-colors').map((themeColor) => `<button type="button" class="btn btn-solid theme-${themeColor.name} justify-self-start">${themeColor.title}</button> <button type="button" class="btn btn-outline theme-${themeColor.name} justify-self-start">${themeColor.title}</button> <button type="button" class="btn btn-subtle theme-${themeColor.name} justify-self-start">${themeColor.title}</button> <button type="button" class="btn btn-text theme-${themeColor.name} justify-self-start">${themeColor.title}</button>`), `
